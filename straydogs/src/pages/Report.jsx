...
import { analyzeImageBatch, saveFeature, getLocation, reverseGeocode, COLORS, SIZES, SEXES, AGES, checkBackend } from '../lib/vision.js'
import { addDog } from '../lib/data.js'
...
export default function ReportPage() {
  ...
  const [photos, setPhotos]           = useState([])       // [{b64, mime, preview}]
  const [captureMode, setCaptureMode] = useState(null)     // null | 'gallery' | 'camera'
  ...
  const [form, setForm]               = useState({ reporter_name: profile?.name || '', notes: '', sex: 'unknown', age: 'adult (1.5-7 yr)', injured: false, injury_notes: '' })
  ...
  if (step === 'success') return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 32, textAlign: 'center', background: '#f4f4f0' }}>
      ...
      <h2 style={{ fontSize: 20, fontWeight: 800, marginBottom: 8 }}>Dog added!</h2>
    ...
    return (
      <div style={{ background: '#f4f4f0', minHeight: '100dvh' }}>
        ...
        <div style={{ padding: '16px 14px' }}>
          ...
          {/* Details form — colour and size pre-filled by AI */}
          <div style={{ background: '#fff', borderRadius: 12, padding: '16px', marginBottom: 14, border: '1px solid #eee' }}>
            ...
            <label style={lbl}>
              Age <span style={{ fontWeight: 400, color: '#888' }}>— AI couldn't predict, please fill in</span>
            </label>
